  ...
  return (
    <div className="bg-white dark:bg-gray-800 shadow rounded-lg p-6 hover:shadow-lg transition-shadow duration-200">
      <div className="flex items-start justify-between">
        ...
        {/* Action Button - View Applications for Active Jobs, Subscribe for others */}
        {activeTab === 'active' ? (
          <Link
            href={`/recruiter/jobs/${jobId}/applications`}
            className={cn(
              'ml-4 inline-flex items-center px-4 py-2 border border-transparent rounded-md text-sm font-medium',
